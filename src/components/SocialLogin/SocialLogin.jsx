...
const SocialLogin = () => {
  const { googleLogin, githubLogin, fbLogin } = useAuth();
  ...
  return (
    <>
      ...
      <div className="mb-6 p-2 text-center me-2 ">
        ...
        <button onClick={() => handleSocialLogin(fbLogin)} type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-2 focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
